...
url = st.selectbox("Select which site you would like to use to create your study materials:", ["https://www.encyclopedia.com", "https://www.britannica.com/" "https://britannicaeducation.com/britannica-academic/"])
...
if st.button("Create Study Materials"):
    st.write("Creating...")
    if url:
        result = scrape_website(url, topic)
    if alt_url:
